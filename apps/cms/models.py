...
class CMSUser(db.Model):
    ...
    def permissions(self):
        ...
        for role in self.roles:
            all_permissions |= role.permission
...
cms_role_user = db.Table(
    ...
    db.Column('cms_user_id', db.Integer, db.ForeignKey('cms_user.uid'), primary_key=True),
)
...
class CMSRole(db.Model):
    ...
    permission = db.Column(db.Integer, default=CMSPersmission.VISITOR)
